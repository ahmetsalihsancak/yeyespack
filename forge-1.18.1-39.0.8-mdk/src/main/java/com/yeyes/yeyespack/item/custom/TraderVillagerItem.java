		...
		if (!world.isClientSide) {
			...
			if (clickedBlock.getBlock() == Blocks.GLASS) {
				...
				String command = "/summon villager "
						...
						+ "				},"
						+ "			sell:{"
						+ "				id:\"minecraft:cobblestone\",Count:16"
						+ "				},"
						+ "			rewardExp:0b,maxUses:9999999"
						+ "			},{"
						+ "			buy:{"
						...
						+ "			},{"
						+ "			buy:{"
						+ "				id:\"yeyespack:gold_currency\",Count:4"
						+ "				},"
						+ "			sell:{"

...
public enum ModArmorMaterial implements ArmorMaterial {
   TRADER_SUIT("trader", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
      return Ingredient.of(ModItems.GOLD_CURRENCY.get());
   });
   ...
   public String getName() {
      return YeyesPack.MOD_ID + ":" + this.name;
   }
